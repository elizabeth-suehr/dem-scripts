...
def sphereclump_series_simulation_specific():
...
def make_and_gen(remake_base_particle_shapes, make_vtk_files):
    ...
    # Include Rod 3
    simulation_sphereclump = sphereclump_series_simulation_specific()
    simulation_sphereclump.generate_liggghts_files([4, 4, 2], random_orientation=False)
    if make_vtk_files:
